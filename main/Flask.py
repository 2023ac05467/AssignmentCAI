...
# Paths
FINETUNED_MODEL_PATH = "../ipynb/qa_finetuned_model_saved"
...
# ===============================
def generate_response_groq(user_query, retrieved_chunks, model_name="llama-3.1-70b-versatile"):
...
# ===============================
app = Flask(__name__)
### Before request to load models and data
@app.before_request
def load_models():
...
if __name__ == '__main__':
    ...
    # Ensure the port is available and not blocked by other services
    print("Starting Flask app at port 5050")
